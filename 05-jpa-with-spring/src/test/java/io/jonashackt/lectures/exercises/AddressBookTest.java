...
public class AddressBookTest {
    ...
    @Test
    void should_create_database_and_write_and_read_person() {

        // Table Person is automatically created by JPA Persistence Provider
        Person luis = new Person("Luis", "Meyer", "luis.meyer@web.de");

        addressbookRepository.save(luis);
        Person personFromDatabase = addressbookRepository.findById(luis.getId()).get();
